...
class Admin extends MY_Controller
{
    ...
    public function reserv_activation($reserv_id)
    {
        $extension = 'index.php/';
        $table = $this->post('table');
            ...
            $sweet = '<script>
                setTimeout(function() {
                    Swal.fire({
                        position: "center",
                        icon: "error",
                        title: "เปิดใช้ห้องบริการไม่สำเร็จ",
                        showConfirmButton: true,
                    }).then(function(){
                        window.location = "' . base_url() . $extension . '/admin/check/reserv/' . $table . '"; 
                    });
        ...
        return $this->sweet($sweet, 'Activation Reserv', 'admin');
