...
<div class="container">
    ...
    <?= $this->load->view('admin/reservation/edit/component/title',[],true)?>
         <form class="text-end" action="<?php echo base_url('index.php/admin/update/vdo'); ?>" id="formId"
...
<script>
    ...
    try {
        const timeUrl = "<?= site_url("vdo/time/".$row['r_id']) ?>"; // Ensure this is a valid URL string
