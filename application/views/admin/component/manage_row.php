<div class="d-flex  justify-content-center align-items-center gap-2 ">
            ...
            <i class="bi bi-search view-reserved-button" data-r-id="<?= $row['r_id']?>" data-reserved-id="<?= $row['reserv_id']?>" ></i>
            </button>
            ...
            <div style="display:inline;">
                ...
                <button type="button" class="btn btn-secondary btn-action delete-button"
                    data-user-id="<?= $row['reserv_id']; ?>"  data-user-fullname="<?= $row['fullname']; ?> "><i class="bi bi-x-square delete-button" data-user-id="<?= $row['reserv_id']; ?>"  data-user-fullname="<?= $row['fullname']; ?> "></i></button>
            </div>
        </div>
