...
<tbody>
    <?php
     ...
     <span class='info-box-icon info-box-icon-top text-bg-primary shadow-sm' data-label='ห้องถูกเปิดใหม่โดย Admin'>
      <i class='bi text-center bi-arrow-counterclockwise fs-5'></i>
      </span>
      </div>";
    $verified ="
    <div class='d-flex  justify-content-center align-items-center gap-2'>
    <span class='info-box-icon info-box-icon-top text-bg-success text-center shadow-sm' data-label='ห้องยืนยันเรียบร้อย'>
