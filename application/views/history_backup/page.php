...
<link rel="stylesheet" href="<?= base_url() ?>public/cdn/bootstrap-icons-1.13.1/bootstrap-icons.min.css"/>
...
<script>$('a[data-bs-toggle="tab"]').on('shown.bs.tab', function () {
  Object.values(tables).forEach(dt => dt.responsive.recalc());
});</script>
