            ...
            <li class="nav-item">
              ...
              <li class="nav-item menu-open  ">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item ">
                    <a href="<?= base_url('index.php/admin/statistic/report/') ?>" class="nav-link <?= $page == "report_page"  ? "active" : '' ?>  ">
                    <?= $page == "report_page" ? '<i class="nav-icon bi bi-circle-fill"></i>' : '<i class="nav-icon bi bi-circle"></i>' ?>
